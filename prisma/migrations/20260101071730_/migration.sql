/*
  ...
  - You are about to drop the column `factor` on the `ProductUnit` table. All the data in the column will be lost.
  - Added the required column `defaultValue` to the `ProductUnit` table without a default value. This is not possible if the table is not empty.
  - Added the required column `variantValue` to the `ProductUnit` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_ProductUnit" (
    ...
    "variantValue" REAL NOT NULL DEFAULT 1,
    "price" REAL NOT NULL,
    "cost" REAL NOT NULL,
