...
INSERT INTO "new_ProductUnit" ("archived", "cost", "createdAt", "factor", "id", "isBase", "name", "price", "productId", "quantityInBase", "updatedAt") SELECT "archived", "cost", "createdAt", "factor", "id", "isBase", "name", "price", "productId", "quantityInBase", "updatedAt" FROM "ProductUnit";
